package com.aventurape.comments_service.infrastructure.security.jwt;

import com.aventurape.comments_service.infrastructure.security.jwt.JwtTokenUtil;
                ...
                if (jwtTokenUtil.validateToken(jwt)) {
                    ...
                    if (StringUtils.hasText(username) && SecurityContextHolder.getContext().getAuthentication() == null) {
                        ...
                        logger.debug("No se estableció la autenticación: username vacío ({}) o ya existe autenticación ({})", 
                                StringUtils.hasText(username), SecurityContextHolder.getContext().getAuthentication() != null);
                    }
                } else {
